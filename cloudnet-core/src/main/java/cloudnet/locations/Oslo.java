 ...
 * elecrticity pricing ( http://en.wikipedia.org/wiki/Electricity_pricing)
 * Temperature data ( http://en.wikipedia.org/wiki/Oslo)
 *
 *
 * @author Dmytro Grygorenko <dmitrygrig(at)gmail.com>
 */
public class Oslo extends BaseLocation implements Location {

    private static final String TimeZoneString = "Europe/Oslo";
    private static final String Country = "Norway";
    private static final ZoneId TimeZone = ZoneId.of(TimeZoneString);

    private static final double DayEnergyPrice = .159; // .159 USD/kWh
    private static final double NightEnergyPrice = DayEnergyPrice * .7;
...
//       return new GeneratedTemperatureModel(new PeriodicWorkloadModel(-3.3, 15.0, .05, TimeFrame.Day, 7));
//    }
    ...
    public long getSAIDI() {
        ...
        return (long) (218.0 * TimeFrame.Minute);
    }
