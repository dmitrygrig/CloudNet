...
/**
 * More info here: http://stackoverflow.com/questions/603013/dumping-a-java-objects-properties
 *
...
public class Dumper {
    ...
    class DumpContext {
        ...
        HashMap<Object, Integer> visited;
    ...
    protected static String dump(Object o, DumpContext ctx) {
        ...
        if (oClass.isArray()) {
            ...
            buffer.append("[\n");
            int rowCount = ctx.maxArrayElements == 0 ? Array.getLength(o) : FastMath.min(ctx.maxArrayElements, Array.getLength(o));
